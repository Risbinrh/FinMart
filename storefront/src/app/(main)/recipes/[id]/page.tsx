              ...
              <CardContent className="p-4">
                <div className="space-y-4">
                  {recipeData.instructions.map((step, index) => (
                    ...
                    >
                      <div className={`h-6 w-6 rounded-full flex items-center justify-center text-xs font-medium shrink-0 transition-colors ${
            ...
            <Card>
              <CardContent className="p-4">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-5 gap-4">
                  ...
                  <div className="text-center p-3 bg-muted rounded-lg col-span-2 sm:col-span-1">
