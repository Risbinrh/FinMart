  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-blue-50 to-cyan-50 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary via-primary/95 to-blue-600 text-white p-12 flex-col justify-between">
        <div>
          ...
          <h1 className="text-4xl font-bold mb-4">
            Join the FreshCatch<br />Family Today
          </h1>
          <p className="text-lg text-primary-foreground/80 mb-8">
            Create your account and start ordering the freshest seafood in Chennai, delivered right to your doorstep.
          </p>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-4 p-4 bg-white/10 backdrop-blur rounded-xl">
            ...
            <div>
              ...
              <p className="text-sm text-primary-foreground/70">Get ₹100 off on your first order</p>
            </div>
          </div>
          <div className="flex items-center gap-4 p-4 bg-white/10 backdrop-blur rounded-xl">
            <div className="h-12 w-12 bg-white/20 rounded-xl flex items-center justify-center">
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12 overflow-y-auto">
        <Card className="w-full max-w-md border-0 shadow-2xl my-6">
          <CardHeader className="text-center pb-2">
            ...
            <CardDescription className="text-base">Join FreshCatch for fresh fish delivery</CardDescription>
          </CardHeader>
